...
img1=pygame.image.load('romanl.png')
...
def design(rectlist):
    height=  int(display_height/7)
    if rectlist[0] == 't':
        pygame.draw.rect(gameDisplay, blue, (10, 10, 60, height - 10))
    else :
        pygame.draw.rect(gameDisplay, (92,46,6), (10, 10, 60, height - 10))#(topleftcordinates,width,heigjt)
    if rectlist[1] == 't':
        pygame.draw.rect(gameDisplay, blue, (730, 10, 60, height - 10))
    else :
                ...
                for event in pygame.event.get():
                    ...
                    if event.type == pygame.KEYDOWN:
                        if event.key == pygame.K_LEFT:
                            gameDisplay.blit(img1,[lead_x,lead_y])
                            pygame.display.update()
                            lead_x_change = -10
                            lead_y_change = 0
